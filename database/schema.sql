...
-- =============================================================================
-- Kept at the very end and apart from everything else on purpose. Supabase runs
-- a SQL script as ONE transaction, and `CREATE POLICY ... ON storage.objects`
-- fails with "must be owner of table objects" on many projects — which would
-- roll back every table above it. Nothing else in this file depends on these
-- buckets: showcase image upload is optional, and image_url simply stays NULL.
-- If this section errors, create the bucket + policies in the dashboard
-- (see database/migrations/2026-07-26_promote_showcase_storage.sql).
-- =============================================================================
